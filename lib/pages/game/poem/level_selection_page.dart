...
// 使用前缀来避免 GameMode 的命名冲突
import '../number/game_page.dart' as NumberMode;
import 'game_page.dart' as PoemMode;
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => PoemMode.GamePage(
                            gameMode: PoemMode.GameMode.training,
